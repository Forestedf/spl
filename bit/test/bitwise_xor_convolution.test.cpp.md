...
data:
  ...
  bundledCode: "#line 1 \"bit/test/bitwise_xor_convolution.test.cpp\"\n#define PROBLEM\
    ...
    \      write_char('\\n');\n    }\n};\n\nReader rd(stdin);\nWriter wr(stdout);\n\
    #line 6 \"bit/test/bitwise_xor_convolution.test.cpp\"\n\nint main() {\n    using\
    \ M = ModInt<998244353>;\n    i32 n;\n    rd.read(n);\n    V<M> a(1 << n), b(1\
    \ << n);\n    REP(i, 1 << n) {\n        rd.read(a[i].val);\n    }\n    REP(i,\
    \ 1 << n) {\n        rd.read(b[i].val);\n    }\n    V<M> c = bitwise_xor_convolution(a,\
    \ b);\n    REP(i, 1 << n) {\n        wr.writeln(c[i].val);\n    }\n}\n"
  ...
  requiredBy: []
  timestamp: '2026-06-19 15:41:44+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: bit/test/bitwise_xor_convolution.test.cpp
layout: document
redirect_from:
- /verify/bit/test/bitwise_xor_convolution.test.cpp
- /verify/bit/test/bitwise_xor_convolution.test.cpp.html
