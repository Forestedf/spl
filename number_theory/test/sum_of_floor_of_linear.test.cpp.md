...
data:
  ...
  bundledCode: "#line 1 \"number_theory/test/sum_of_floor_of_linear.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/sum_of_floor_of_linear\"\n#define\
    ...
    #line 6 \"number_theory/test/sum_of_floor_of_linear.test.cpp\"\n\nvoid solve()\
    \ {\n    i32 n, m, a, b;\n    rd.read(n, m, a, b);\n    wr.writeln(floor_sum<i64,\
    \ i64>(0, n, a, b, m));\n}\n\nint main() {\n    i32 t = 1;\n    rd.read(t);\n\
    \    while (t--) {\n        solve();\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: number_theory/test/sum_of_floor_of_linear.test.cpp
layout: document
redirect_from:
- /verify/number_theory/test/sum_of_floor_of_linear.test.cpp
- /verify/number_theory/test/sum_of_floor_of_linear.test.cpp.html
