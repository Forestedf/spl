...
data:
  ...
  bundledCode: "#line 1 \"poly/test/yuki_1145.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/1145\"\
    \n#line 2 \"poly/rational_sum_1.hpp\"\n#include <utility>\n#line 2 \"poly/fps_inv.hpp\"\
    \n#include <algorithm>\n#line 3 \"poly/fft.hpp\"\n#include <array>\n#include <vector>\n\
    ...
    \  read(name);\n#line 4 \"poly/test/yuki_1145.test.cpp\"\n\nint main() {\n   \
    \ using M = ModInt<998244353>;\n    I32(n, m);\n    V<M> b(n);\n    REP(i, n)\
    \ {\n        read(b[i].val);\n    }\n    V<M> a(n, M(1));\n    V<M> c = rational_sum_1(a,\
    \ b, m + 1);\n    REP(i, 1, m + 1) {\n        cout << c[i] << \" \\n\"[i == m];\n\
    \    }\n}\n"
  ...
  verifiedWith: []
documentation_of: poly/test/yuki_1145.test.cpp
layout: document
redirect_from:
- /verify/poly/test/yuki_1145.test.cpp
- /verify/poly/test/yuki_1145.test.cpp.html
