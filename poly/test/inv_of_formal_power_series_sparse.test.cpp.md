...
data:
  ...
  bundledCode: "#line 1 \"poly/test/inv_of_formal_power_series_sparse.test.cpp\"\n\
    #define PROBLEM \"https://judge.yosupo.jp/problem/inv_of_formal_power_series_sparse\"\
    \n#line 2 \"poly/fps_inv_sparse.hpp\"\n#include <cassert>\n#include <utility>\n\
    #include <vector>\n// O(n * (# of nonzero))\ntemplate <typename T>\nstd::vector<T>\
    \ fps_inv_sparse(const std::vector<T> &f) {\n    assert(!f.empty() && f[0] !=\
    ...
    \      write_char('\\n');\n    }\n};\n\nReader rd(stdin);\nWriter wr(stdout);\n\
    #line 6 \"poly/test/inv_of_formal_power_series_sparse.test.cpp\"\n\nint main()\
  ...
  verifiedWith: []
documentation_of: poly/test/inv_of_formal_power_series_sparse.test.cpp
layout: document
redirect_from:
- /verify/poly/test/inv_of_formal_power_series_sparse.test.cpp
- /verify/poly/test/inv_of_formal_power_series_sparse.test.cpp.html
