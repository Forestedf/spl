...
data:
  ...
  bundledCode: "#line 1 \"number_theory/test/dynamic_modint_stress.test.cpp\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/lesson/2/ITP1/1/ITP1_1_A\"\
    ...
    \ n - 1)(mt);\n}\n#line 5 \"number_theory/test/dynamic_modint_stress.test.cpp\"\
    \n\nusing M = DynamicModInt<0>;\n\nvoid test() {\n    u32 m = uniform(1u, 1u <<\
    \ 31);\n    M::set_mod(m);\n    REP(iter, 10'000'000) {\n        u32 x = uniform(1u\
    \ << 31);\n        u32 y = uniform(1u << 31);\n        M a(x);\n        M b(y);\n\
    \        assert((a + b).val == (x + y) % m);\n        assert((a - b).val == safe_mod((i64)x\
  ...
  verifiedWith: []
documentation_of: number_theory/test/dynamic_modint_stress.test.cpp
layout: document
redirect_from:
- /verify/number_theory/test/dynamic_modint_stress.test.cpp
- /verify/number_theory/test/dynamic_modint_stress.test.cpp.html
