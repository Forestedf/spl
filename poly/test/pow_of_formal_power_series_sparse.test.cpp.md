...
data:
  ...
  bundledCode: "#line 1 \"poly/test/pow_of_formal_power_series_sparse.test.cpp\"\n\
    ...
    \      write_char('\\n');\n    }\n};\n\nReader rd(stdin);\nWriter wr(stdout);\n\
    #line 6 \"poly/test/pow_of_formal_power_series_sparse.test.cpp\"\n\nint main()\
  ...
  verifiedWith: []
documentation_of: poly/test/pow_of_formal_power_series_sparse.test.cpp
layout: document
redirect_from:
- /verify/poly/test/pow_of_formal_power_series_sparse.test.cpp
- /verify/poly/test/pow_of_formal_power_series_sparse.test.cpp.html
