...
data:
  ...
  bundledCode: "#line 1 \"graph/test/nazo_bipartitematching.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/bipartitematching\"\n#define FAST_IO\n#line\
    \ 2 \"graph/nazo_bipartite_matching.hpp\"\n#include <algorithm>\n#include <cassert>\n\
    ...
    #line 6 \"graph/test/nazo_bipartitematching.test.cpp\"\n\nvoid solve() {\n   \
    \ i32 l, r, m;\n    rd.read(l, r, m);\n    V<pi> es(m);\n    for (auto &[a, b]\
    \ : es) {\n        rd.read(a, b);\n    }\n    V<i32> ml = bipartite_matching(l,\
  ...
  verifiedWith: []
documentation_of: graph/test/nazo_bipartitematching.test.cpp
layout: document
redirect_from:
- /verify/graph/test/nazo_bipartitematching.test.cpp
- /verify/graph/test/nazo_bipartitematching.test.cpp.html
